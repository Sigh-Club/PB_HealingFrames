    ...
    return {
        ...
        frame = {
            ...
            bars = {
                ...
                nameLength = 10, shortenNames = true,
                horizontalFill = true, unitsPerRow = 1,
            },
            grid = {
                size = 40, columns = 5, spacing = 2, scale = 1,
                nameLength = 6, shortenNames = true,
                horizontalFill = true,
            },
        },
        scan = {
